...
def load_first_section(items):
    ...
    for item in items:
        itemtxt = it.load_first_section_item(item, order)
        retstr += itemtxt
        order += 1
    return retstr
...
def load_second_section(items):
    ...
    order = 1
    for item in items:
        itemtxt = it.load_second_section_item(item, order)
        retstr += itemtxt
        order += 1
    return retstr
...
def load_third_section(items):
    ...
    order = 1
    for item in items:
        itemtxt = it.load_third_section_item(item, order)
        retstr += itemtxt
        order += 1
    return retstr
...
def load_fourth_section(items):
    ...
    order = 1
    for item in items:
        itemtxt = it.load_fourth_section_item(item, order)
        retstr += itemtxt
        order += 1
    return retstr
